...
<html lang="en">
  ...
  <body>
   ...
   <div class="card-body">
      <form  name="myForm"  id="reg-form" action="search" method="POST">
  
  
<div class="form-group">
                                    <label for="namexyz1">Place Name:</label>
                                    <input name="place_name" type="text" class="form-control" id="namexyz1" aria-describedby="emailHelp" placeholder="Enter Place Name">
                                </div>
