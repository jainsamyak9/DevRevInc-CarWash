  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <h6>Email: jainsamyak9@gmail.com</h6>
        <h6>Phone No:9897831608   </h6>   
        </br>
          
             <center><h5>Admin details</h5></center>
                <h6>Email: 19bcs6054@cuchd.in</h6>
        <h6>Phone No:9897831608   </h6>   
        </br>
...
Login
 ...
 <a class="dropdown-item" href="User_Login.jsp">User Login</a>
    <a class="dropdown-item" href="Admin_Login.jsp">Admin login</a>
   <a class="dropdown-item" href="AddUser.jsp">Sign Up</a>
